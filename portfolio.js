...
if (projectsSection && projectsContainer && projectCards.length) {
  ...
  searchSizer.style.fontFamily = getComputedStyle(searchInput).fontFamily;
  searchSizer.style.fontWeight = getComputedStyle(searchInput).fontWeight;
  searchSizer.style.letterSpacing = getComputedStyle(searchInput).letterSpacing;
  ...
  searchInput.addEventListener("focus", syncSearchWidth);
